    ...
    public class FirstPersonController : NetworkBehaviour {
        ...
        private void Start() {
            ...
            if (!isLocalPlayer) {
                ...
                m_Animator = transform.FindChild("bm_prefabs").GetComponent<Animator>();
            }
        }
        ...
        private void Update() {
            ...
            if (Attack()) m_Animator.SetBool("attack", true);
        ...
        private bool Attack() {
            if (CrossPlatformInputManager.GetButton("Fire1")) return true;
            return false;
